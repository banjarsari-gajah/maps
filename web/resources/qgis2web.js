...
map.getView().fit([12324919.539947, -770910.979548, 12330056.108247, -767756.184120], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Banjarsari</h2>';
        return titleElement;
    })(),
